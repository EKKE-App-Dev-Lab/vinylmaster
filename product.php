        ...
        <div class="col mt-4">
            ...
            <form id="form-pd" method="POST" action="product.php?action=add&product_id=<?php echo $product_id; ?>">
                <div class="box my-4">
                    ...
                    <input type="number" value="1" min="1" max="100" name="input_quantity" id="input_quantity"
                           class="input-quantity mx-2 p-3 px-4">
                    ...
                    <input type="submit" name="add-to-cart" id="add-to-cart-btn" value="Kosárba"
                           class="btn btn-primary btn-lg my-4 button"/>
