        ...
        if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
            ...
            if ($responseKey['success']) {
                ...
                if (mysqli_num_rows($result) === 1) {
                    ...
                    $altMessage = "Username: $uname Jelszó: $newPassword Belépés után egyből változtasd meg a jelszavad!";
...
<div class="login-page">
    <div class="form">
        ...
        <form class="login-form" method="post" actions="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            ...
            <span class="input-error"><?php if ($errCriteria != "") {
                    echo "$errCriteria <br><br>";
                } ?></span>
            <div name="g-recaptcha-response" class="g-recaptcha"
                 data-sitekey="6LdT9A0aAAAAAPLi4Ab29xdM28aipZ0D3IyXbjXQ"></div>
